...
merge 1:1 country_fullname using "$main/tables/Global_Consumption_Database/code_country_correspondance.dta"
keep if _merge==3
drop _merge
...
sort pop2018_sort
export excel using "$main\tables\Global_Consumption_Database\country_pop.xls" , replace
...
egen lac_pop_sample=sum(pop2018) if country_2let=="BO" | country_2let=="BR" | country_2let=="CL" | country_2let=="CO" | country_2let=="CR" | country_2let=="DO" | country_2let=="EC" | country_2let=="MX" | country_2let=="PE" | country_2let=="PY" | country_2let=="UY" 
