...
************************************************************************	
	...
	*keep if country_code == "PY" 		// To run on one country select its acronym  
...
*	global annualization_factor `: word `c' of `annualization_factor''	
	...
	global country_name = substr("$country_fullname",1,strlen("$country_fullname")-4)	
		...
		******************************************
		...
		gen mean_exp_dollar= `mean_exp'  / $exchange_rate
		}
...
putexcel D25 ="Stat. Office"
putexcel D26 ="World Bank"
putexcel D27 ="World Bank"
putexcel D28 ="World Bank"
putexcel D29 ="World Bank"
putexcel D30 ="U. of Cape Town"
sleep 500
putexcel D31 ="World Bank"
putexcel D32 ="Stat. Office"
putexcel D33 ="Stat. Office"
...
import excel "/Users/evadavoine/Dropbox/Regressivity_VAT/Stata/tables/stat_des_appendix.xls", sheet("Table B1 appendix") firstrow clear

drop if Countryname==""		
egen sum=sum(Samplesize)
ta sum // 420753 cited in paper p.5
