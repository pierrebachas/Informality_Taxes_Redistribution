...
******************
	...
	*Graph A 
	...
	ytitle(" ", size (small)) ;
	graph export "$main/graphs/cross_country/missing_bycoicop_bar.pdf", replace 	; 
	...
	*Graph B 
	...
	ytitle(" ", size (small)) ;
	graph export "$main/graphs/cross_country/missing_bycoicop_bar_coicop.pdf", replace 	; 
	...
	******************
	...
	egen mean_total_unspecified= mean(total) // 17%
	...
	* Compute stat for paper p.7 ( total share of unspecified across 31 countries)
	...
	graph export "$main/graphs/cross_country/missing_bycoicop_stackedbar.pdf", replace 	; 
