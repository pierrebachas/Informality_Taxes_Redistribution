...
*********************************************		
	...
	forval k=1/`n_models' {
		...
		* Informal Engel Curve		
		#delim ;
		twoway lpolyci share_informal_1 log_income_pp if tag_1 == 1 & log_income_pp>= `bottom_range' & log_income_pp <= `top_range' [aw = hh_weight],
		...
		graph export "$main/graphs/cross_country/Informality_Engel_Curves/${country_code}_Engel_informal_${income_measure}.pdf", replace ;	
		...
		* Informal Engel Curve with axis titles
		...
		graph export "$main/graphs/cross_country/Informality_Engel_Curves/${country_code}_Engel_informal_${income_measure}_axis.pdf", replace ;	
